...
export default function RootLayout({
  ...
  const renderPopup = () => {
      ...
      switch(activePopup) {
          case 'folder': return <FolderPopup {...props} />;
          case 'packages': return <PackagesPopup {...props} />;
          case 'python': return <PythonPopup {...props} onEnvironmentSwitch={handleEnvironmentSwitch} />;
          case 'metrics': return <MetricsPopup {...props} />;
          case 'settings': return <SettingsPopup {...props} onSettingsChange={handleSettingsChange} />;
          default: return null;
      }
  }
    ...
    <html lang="en">
      ...
      <body data-notebook-path={notebookPath} data-notebook-root={notebookRoot}>
        <div id="app">
            ...
            <div id="kernel-banner" className="kernel-banner" style={{display: 'none'}}>
                <div className="kernel-message">
                    <span className="kernel-status-text">🔴 Kernel Disconnected</span>
                    <span className="kernel-subtitle">The notebook kernel has stopped running. Restart to continue.</span>
                </div>
            </div>
            <div className="kernel-status-bar">
                <div className="kernel-status-indicator">
                    <span id="kernel-status-dot" className="status-dot connecting"></span>
                    <span id="kernel-status-text" className="status-text">Connecting...</span>
                </div>
            </div>
            ...
            <div style={{display: 'none'}}>
                ...
                <img id="copy-icon-template" src="/assets/icons/copy.svg" alt="Copy" />
                <img id="check-icon-template" src="/assets/icons/check.svg" alt="Copied" />
            </div>
        </div>
